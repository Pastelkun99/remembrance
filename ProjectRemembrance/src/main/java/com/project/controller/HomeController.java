...
public class HomeController {
	...
	public String login(HttpSession httpSession, HttpServletResponse response, HttpServletRequest request) throws Exception {
	...
	public String loginPost(Model model, @ModelAttribute() User user, HttpSession httpSession, HttpServletRequest request) {
		try {
			...
			model.addAttribute("msg", "로그인에 실패했습니다. 아이디와 비밀번호를 확인해주세요.");
			model.addAttribute("href", request.getContextPath()+"/login.do");
			return "alert";
		}
	}
